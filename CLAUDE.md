...
- [ ] Restringir API Key de Google Calendar por dominio
- [ ] Activar NS y BQL cuando estén disponibles
- [ ] Fase 2: turnero avanzado con panel por barbero (presupuestado en $1.3M–$1.6M ARS)